...
const DMJ_I18N = {
  ...
  // saler นับได้แต่ไม่บังคับ → ใช้คนละหัวข้อกับของหน้าร้าน/พนักงานที่ขึ้นต้นด้วย "①"
  "นับหน้าร้าน — เหลือกี่ชิ้น?":
    { en: "Count storefront — how many left?", my: "ဆိုင်ရှေ့ ရေတွက်ပါ — ဘယ်နှစ်ခု ကျန်လဲ?" },
  "ไม่บังคับ — นับแล้วระบบบันทึกให้เลย":
    { en: "Optional — counts are saved automatically", my: "မဖြစ်မနေ မဟုတ်ပါ — ရေတွက်ပြီးလျှင် စနစ်က အလိုအလျောက် သိမ်းပါမည်" },
