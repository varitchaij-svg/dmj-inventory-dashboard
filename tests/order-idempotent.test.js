...
// ชีตปลอม: cids[i] = ค่าคอลัมน์ M ของแถวที่ 3+i (ข้อมูลเริ่มแถว 3 เหมือนชีตจริง)
...
describe('findOrderRowByCid_ — หาคำสั่งเดิมจาก cid', () => {
  ...
  it('อ่านเฉพาะคอลัมน์ M คอลัมน์เดียว และไม่เกิน ORD_CID_SCAN_ROWS แถว', () => {
  ...
  it('คอลัมน์ cid ต้องเป็น M (13) — ไม่ทับ A..K ที่ handleOrder_ เขียน และไม่ทับ N (printFlag)', () => {
    expect(COL_ORD_CID).toBe(13);
