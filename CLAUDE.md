...
**การเทียบ "ชื่อคน" ทนอักขระพิเศษ** — ชื่อ LINE ของพนักงานมักมีอีโมจิ/ตัวอักษรตกแต่ง
...
เทสต์: `tests/product-owner-assign.test.js` (65 เคส — **eval ฟังก์ชันจริงจาก `.gs` ไม่ copy**
