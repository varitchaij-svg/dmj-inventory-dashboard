...
**มี Vitest test suite แล้ว** — 1587 tests, 48 test files, ทั้งหมด pass (+ browser 90/90)
...
เทสต์: `tests/online-sale.test.js` (53 เคส — eval ฟังก์ชันจริงจาก `.jsx` + `.gs` ไม่ copy
เหมือน auth.test.js · รวม `appendSaleBillRow_` ที่รันจริงกับชีตจำลองเพื่อยืนยันตำแหน่งคอลัมน์)
+ browser test `ขายออนไลน์ — สรุปส่งลูกค้า` ที่กรอกฟอร์มจริงบนจอมือถือแล้วเช็คว่า
**ค่าส่งเข้ายอด (250+50=300) · สรุปมีเลขบัญชี/ที่อยู่/ขนส่ง/ปุ่มส่งครบ · ไม่มีใบเสร็จปริ้นปนมา**
