...
**มี Vitest test suite แล้ว** — 1589 tests, 48 test files, ทั้งหมด pass (+ browser 91/91)
...
เทสต์: `tests/online-sale.test.js` (55 เคส — eval ฟังก์ชันจริงจาก `.jsx` + `.gs` ไม่ copy
