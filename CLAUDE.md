...
- **เส้นทางชื่อ (ทางกู้ที่แคบลง)** ต้องผ่าน **ทั้ง 2 ข้อ**:
  ...
  · **แถวเดิมต้องเป็น `pending` เท่านั้น** (`canUpgrade`) — `pending` = ระบบตั้งเอง ยังไม่มีมนุษย์
    ตัดสินใจ · **`disabled` คือการตัดสินใจของเจ้าของ ห้ามเปิดกลับด้วยชื่อเด็ดขาด** · role อื่นที่
    active อยู่ก็ไม่ทับ
