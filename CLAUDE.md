...
ROLE_TABS = {
  ...
  warehouse:  categories, storage, stockcount, orders, ordersummary,
              mtojobs, labels        // หมายเหตุ: ไม่มี "stock" (ใช้ stockcount แทน)
...
**มี Vitest test suite แล้ว** — 380 tests, 13 test files, ทั้งหมด pass
