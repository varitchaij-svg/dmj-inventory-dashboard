...
(หมายเหตุ: `suggestNextSku` ในโค้ด (views-main.jsx) เป็นแค่ตัวช่วยเดา running number ถัดไป
จาก SKU pattern เดิมในหมวดเดียวกัน ไม่ได้รู้จัก business rule นี้ — เวลาคุยกับผู้ใช้เรื่องสร้าง SKU
ใหม่ ให้ยึด business rule ข้างต้นเป็นหลัก ไม่ใช่ผลจากฟังก์ชันนี้)
